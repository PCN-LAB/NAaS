...
FROM '/var/lib/postgresql/NAaS/Database/province.csv' DELIMITER ',' CSV HEADER;
...
FROM '/var/lib/postgresql/NAaS/Database/district.csv' DELIMITER ',' CSV HEADER;
...
FROM '/var/lib/postgresql/NAaS/Database/tehsil.csv' DELIMITER ',' CSV HEADER;
